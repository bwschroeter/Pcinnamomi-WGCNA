...
knitr::include_graphics("~/WGCNA_Pcinnamomi/pheatmap1.png")
```

```{r, echo=FALSE, out.width='100%'}
knitr::include_graphics("~/WGCNA_Pcinnamomi/pheatmap2.png")
```

```{r, echo=FALSE, out.width='100%'}
knitr::include_graphics("~/WGCNA_Pcinnamomi/pheatmap3.png")
```
